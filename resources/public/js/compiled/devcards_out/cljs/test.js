...
var args33068 = [];
var len__25923__auto___33072 = arguments.length;
var i__25924__auto___33073 = (0);
while(true){
if((i__25924__auto___33073 < len__25923__auto___33072)){
args33068.push((arguments[i__25924__auto___33073]));

var G__33074 = (i__25924__auto___33073 + (1));
i__25924__auto___33073 = G__33074;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args33068.length)].join('')));
...
var G__33071 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__33071,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__33071;
}
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq33076){
var G__33077 = cljs.core.first.call(null,seq33076);
var seq33076__$1 = cljs.core.next.call(null,seq33076);
var G__33078 = cljs.core.first.call(null,seq33076__$1);
var seq33076__$2 = cljs.core.next.call(null,seq33076__$1);
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__33077,G__33078,seq33076__$2);
});
...
var file = cljs.core.get.call(null,map__33085__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__33085__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__33085__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__33085,map__33085__$1,file,line,column){
return (function (p1__33082_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__33082_SHARP_));
});})(map__33085,map__33085__$1,file,line,column))
...
var temp__4657__auto___33087 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___33087)){
var message_33088 = temp__4657__auto___33087;
cljs.core.println.call(null,message_33088);
} else {
}
...
var temp__4657__auto___33089 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___33089)){
var message_33090 = temp__4657__auto___33089;
cljs.core.println.call(null,message_33090);
} else {
}
...
var G__33100 = exception.stack;
var G__33100__$1 = (((G__33100 == null))?null:clojure.string.split_lines.call(null,G__33100));
var G__33100__$2 = (((G__33100__$1 == null))?null:cljs.core.get.call(null,G__33100__$1,depth));
if((G__33100__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__33100__$2);
}
} else {
...
var vec__33101 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__33101,(0),null);
var column = cljs.core.nth.call(null,vec__33101,(1),null);
var vec__33104 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__33104,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__33104,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__33104,(2),null);
...
var m__$1 = (function (){var G__33108 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__33108) {
case "fail":
...
var G__33114 = (function (){var G__33113 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__33113);
} else {
return G__33113;
}
})();
...
return cljs.core.vary_meta.call(null,G__33116,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e33119){var e = e33119;
var G__33120 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__33120) {
...
var vec__33125 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__33125,(0),null);
var types = vec__33125;
...
return cljs.core.map.call(null,(function (p__33137){
var vec__33138 = p__33137;
var ns = cljs.core.nth.call(null,vec__33138,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__33138,(1),null);
return ((function (vec__33138,ns,vars__$1){
return (function (){
...
var G__33141 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__33141) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__33141,env,once_fixtures,each_fixtures,vec__33138,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__33141,env,once_fixtures,each_fixtures,vec__33138,ns,vars__$1){
return (function (){
var seq__33142 = cljs.core.seq.call(null,vars__$1);
var chunk__33143 = null;
var count__33144 = (0);
var i__33145 = (0);
while(true){
if((i__33145 < count__33144)){
var v = cljs.core._nth.call(null,chunk__33143,i__33145);
var temp__4657__auto___33147 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___33147)){
var t_33148 = temp__4657__auto___33147;
each_fixture_fn.call(null,((function (seq__33142,chunk__33143,count__33144,i__33145,t_33148,temp__4657__auto___33147,v,each_fixture_fn,G__33141,env,once_fixtures,each_fixtures,vec__33138,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_33148)));
});})(seq__33142,chunk__33143,count__33144,i__33145,t_33148,temp__4657__auto___33147,v,each_fixture_fn,G__33141,env,once_fixtures,each_fixtures,vec__33138,ns,vars__$1))
);
} else {
}
...
var temp__4657__auto__ = cljs.core.seq.call(null,seq__33142);
if(temp__4657__auto__){
var seq__33142__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__33142__$1)){
var c__25659__auto__ = cljs.core.chunk_first.call(null,seq__33142__$1);
var G__33153 = cljs.core.chunk_rest.call(null,seq__33142__$1);
var G__33154 = c__25659__auto__;
var G__33155 = cljs.core.count.call(null,c__25659__auto__);
var G__33156 = (0);
seq__33142 = G__33153;
...
var v = cljs.core.first.call(null,seq__33142__$1);
var temp__4657__auto___33157__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___33157__$1)){
var t_33158 = temp__4657__auto___33157__$1;
each_fixture_fn.call(null,((function (seq__33142,chunk__33143,count__33144,i__33145,t_33158,temp__4657__auto___33157__$1,v,seq__33142__$1,temp__4657__auto__,each_fixture_fn,G__33141,env,once_fixtures,each_fixtures,vec__33138,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_33158)));
});})(seq__33142,chunk__33143,count__33144,i__33145,t_33158,temp__4657__auto___33157__$1,v,seq__33142__$1,temp__4657__auto__,each_fixture_fn,G__33141,env,once_fixtures,each_fixtures,vec__33138,ns,vars__$1))
);
} else {
}
...
});})(each_fixture_fn,G__33141,env,once_fixtures,each_fixtures,vec__33138,ns,vars__$1))
);
});})(each_fixture_fn,G__33141,env,once_fixtures,each_fixtures,vec__33138,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1566349702991