...
var args34100 = [];
var len__25923__auto___34106 = arguments.length;
var i__25924__auto___34107 = (0);
while(true){
if((i__25924__auto___34107 < len__25923__auto___34106)){
args34100.push((arguments[i__25924__auto___34107]));

var G__34108 = (i__25924__auto___34107 + (1));
i__25924__auto___34107 = G__34108;
continue;
} else {
}
break;
...
var f = (function (){var pred__34103 = cljs.core._EQ_;
var expr__34104 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__34103.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__34104))){
return ((function (pred__34103,expr__34104){
return (function (p1__34096_SHARP_){
return console.warn(p1__34096_SHARP_);
});
;})(pred__34103,expr__34104))
} else {
if(cljs.core.truth_(pred__34103.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__34104))){
return ((function (pred__34103,expr__34104){
...
if(cljs.core.truth_(pred__34103.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__34104))){
return ((function (pred__34103,expr__34104){
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__34110){
var map__34113 = p__34110;
var map__34113__$1 = ((((!((map__34113 == null)))?((((map__34113.cljs$lang$protocol_mask$partition0$ & (64))) || (map__34113.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__34113):map__34113);
var opts = map__34113__$1;
var eval_fn = cljs.core.get.call(null,map__34113__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__34115_SHARP_);
});})(new_def))
);
...
return (function (p__34116){
var vec__34117 = p__34116;
var ky = cljs.core.nth.call(null,vec__34117,(0),null);
...
var args34120 = [];
var len__25923__auto___34123 = arguments.length;
var i__25924__auto___34124 = (0);
while(true){
if((i__25924__auto___34124 < len__25923__auto___34123)){
args34120.push((arguments[i__25924__auto___34124]));

var G__34125 = (i__25924__auto___34124 + (1));
i__25924__auto___34124 = G__34125;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args34120.length)].join('')));
...
//# sourceMappingURL=utils.js.map?rel=1566349704994